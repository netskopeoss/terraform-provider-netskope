...
- `schedule` (Attributes List) Schedule configuration for policy enforcement timing (see [below for nested schema](#nestedatt--data--rule_data--schedule))
- `src_countries` (List of String)
- `user_confidence` (Attributes) User Confidence Index filter. Requires the User Confidence Index feature to be enabled on the tenant. (see [below for nested schema](#nestedatt--data--rule_data--user_confidence))
...
<a id="nestedatt--data--rule_data--notify"></a>
### Nested Schema for `data.rule_data.notify`
...
<a id="nestedatt--data--rule_data--schedule"></a>
### Nested Schema for `data.rule_data.schedule`
...
- `time_range` (Attributes List) Date/time ranges when the policy is active (see [below for nested schema](#nestedatt--data--rule_data--schedule--time_range))

<a id="nestedatt--data--rule_data--schedule--time_range"></a>
### Nested Schema for `data.rule_data.schedule.time_range`
...
<a id="nestedatt--data--rule_data--user_confidence"></a>
### Nested Schema for `data.rule_data.user_confidence`
