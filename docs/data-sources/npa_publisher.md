...
page_title: "netskope_npa_publisher Data Source - terraform-provider-netskope"
subcategory: ""
description: |-
...
# netskope_npa_publisher (Data Source)
...
```terraform
data "netskope_npa_publisher" "my_npapublisher" {
  publisher_id = 1
}
```
