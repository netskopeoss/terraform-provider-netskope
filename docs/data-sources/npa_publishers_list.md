...
page_title: "netskope_npa_publishers_list Data Source - terraform-provider-netskope"
subcategory: ""
description: |-
...
# netskope_npa_publishers_list (Data Source)
...
```terraform
data "netskope_npa_publishers_list" "my_npapublisherslist" {
}
```
