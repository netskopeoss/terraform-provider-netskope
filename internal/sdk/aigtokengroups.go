...
type AIGTokenGroups struct {
	rootSDK          *TerraformProviderNs
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newAIGTokenGroups(rootSDK *TerraformProviderNs, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *AIGTokenGroups {
	return &AIGTokenGroups{
		rootSDK:          rootSDK,
...
// ListObjects - List Token Groups
// Returns a paginated list of AI Gateway token groups.
func (s *AIGTokenGroups) ListObjects(ctx context.Context, opts ...operations.Option) (*operations.ListAigTokenGroupsResponse, error) {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "listAigTokenGroups",
		OAuth2Scopes:     nil,
	...
	res := &operations.ListAigTokenGroupsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.AigTokenGroupListResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.AigTokenGroupListResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
