...
func newNPAPublisherApps(rootSDK *TerraformProviderNs, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *NPAPublisherApps {
...
func (s *NPAPublisherApps) ListObjects(ctx context.Context, request operations.GetNPAPublisherAppsRequest, opts ...operations.Option) (*operations.GetNPAPublisherAppsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.PublishersPrivateAppsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PublishersPrivateAppsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
