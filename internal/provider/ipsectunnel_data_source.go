...
var _ datasource.DataSource = &IPSecTunnelDataSource{}
var _ datasource.DataSourceWithConfigure = &IPSecTunnelDataSource{}

func NewIPSecTunnelDataSource() datasource.DataSource {
	return &IPSecTunnelDataSource{}
}

// IPSecTunnelDataSource is the data source implementation.
type IPSecTunnelDataSource struct {
	// Provider configured SDK client.
	client *sdk.TerraformProviderNs
}

// IPSecTunnelDataSourceModel describes the data model.
...
func (r *IPSecTunnelDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (r *IPSecTunnelDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "IPSecTunnel DataSource",
