...
func (r *NPAPublishersBulkProfileUpdatesResourceModel) ToSharedPublisherUpgradeProfileBulkRequest() *shared.PublisherUpgradeProfileBulkRequest {
...
func (r *NPAPublishersBulkProfileUpdatesResourceModel) RefreshFromSharedPublisherUpgradeProfileBulkResponse(resp *shared.PublisherUpgradeProfileBulkResponse) {
	if resp != nil {
		if resp.Data == nil {
			r.Data = nil
		} else {
			...
			for publishersCount, publishersItem := range resp.Data.Publishers {
				var publishers1 tfTypes.UpgradePublisherResponse
				...
				publishers1.SticherPop = types.StringPointerValue(publishersItem.SticherPop)
				...
				if publishersCount+1 > len(r.Data.Publishers) {
					...
					r.Data.Publishers[publishersCount].SticherPop = publishers1.SticherPop
